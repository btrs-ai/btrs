...
### Write Access
- `btrs/evidence/sessions/api-engineer-notes.md`
- `btrs/work/status.md`
- `src/api/`
- `btrs/evidence/sessions/api-engineer.log`
...
- Review design decisions in `btrs/knowledge/decisions/design-decisions.md`
- Check for patterns in `btrs/knowledge/conventions/patterns.md`
...
Update `btrs/evidence/sessions/implementation-notes.md`:
```json
{
  "implementations": [
    {
