...
**Write Access**: `AI/memory/agents/sales/pipeline.json`, `AI/memory/agents/sales/deals.json`, `AI/memory/agents/sales/playbooks.json`
...
**Pipeline Stages** (AI/memory/agents/sales/pipeline.json):
...
5. Write verification report to `.btrs/agents/sales/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/sales/{date}-{task-slug}.md` (use template)
