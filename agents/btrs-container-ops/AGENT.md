...
**Write Access**: `AI/memory/agents/container-ops/cluster-state.json`, `AI/memory/agents/container-ops/deployment-configs.json`
...
5. Write verification report to `.btrs/agents/container-ops/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/container-ops/{date}-{task-slug}.md` (use template)
