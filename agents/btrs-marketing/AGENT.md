...
**Write Access**: `AI/memory/agents/marketing/campaigns.json`, `AI/memory/agents/marketing/performance.json`
...
5. Write verification report to `.btrs/agents/marketing/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/marketing/{date}-{task-slug}.md` (use template)
