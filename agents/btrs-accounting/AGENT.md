...
**Write Access**: `AI/memory/agents/accounting/financials.json`, `AI/memory/agents/accounting/budgets.json`, `AI/memory/agents/accounting/compliance.json`
...
5. Write verification report to `.btrs/agents/accounting/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/accounting/{date}-{task-slug}.md` (use template)
