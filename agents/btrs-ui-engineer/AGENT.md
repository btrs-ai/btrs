...
**Write Access**: `AI/memory/agents/ui-engineer/implementation-notes.json`, `src/components/`
...
5. Write verification report to .btrs/agents/ui-engineer/{date}-{task}.md
...
1. Write agent output to .btrs/agents/ui-engineer/{date}-{task-slug}.md (use template)
