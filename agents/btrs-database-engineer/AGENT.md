...
**Write Access**: `AI/memory/agents/database-engineer/implementation-notes.json`, `src/database/`, `prisma/`, `migrations/`
...
5. Write verification report to .btrs/agents/database-engineer/{date}-{task}.md
...
1. Write agent output to .btrs/agents/database-engineer/{date}-{task-slug}.md (use template)
