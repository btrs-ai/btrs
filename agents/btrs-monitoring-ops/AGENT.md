...
**Write Access**: `AI/memory/agents/monitoring-ops/metrics.json`, `AI/memory/agents/monitoring-ops/incidents.json`, `AI/memory/agents/monitoring-ops/slos.json`
...
5. Write verification report to `.btrs/agents/monitoring-ops/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/monitoring-ops/{date}-{task-slug}.md` (use template)
