...
**Write Access**: `AI/memory/agents/desktop-engineer/implementation-notes.json`, `src/desktop/`
...
5. Write verification report to .btrs/agents/desktop-engineer/{date}-{task}.md
...
1. Write agent output to .btrs/agents/desktop-engineer/{date}-{task-slug}.md (use template)
