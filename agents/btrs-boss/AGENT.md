...
### Write Access
- `AI/memory/agents/boss/active-tasks.json` - Current tasks
- `AI/memory/agents/boss/task-assignments.json` - Agent workload
- `AI/memory/agents/boss/priorities.json` - Project priorities
- `AI/memory/global/project-state.json` - Overall project status
- `AI/logs/boss.log` - Activity log
...
1. Review strategic goals in `priorities.json`
...
5. Write verification report to .btrs/agents/boss/{date}-{task}.md
...
1. Write agent output to .btrs/agents/boss/{date}-{task-slug}.md (use template)
