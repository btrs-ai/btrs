...
**Write Access**: `AI/memory/agents/code-security/vulnerabilities.json`, `AI/memory/agents/code-security/scan-results.json`
...
5. Write verification report to .btrs/agents/code-security/{date}-{task}.md
...
1. Write agent output to .btrs/agents/code-security/{date}-{task-slug}.md (use template)
