...
**Write Access**: `AI/memory/agents/devops/deployment-state.json`, `AI/memory/agents/devops/platform-config.json`, `AI/memory/agents/devops/runbooks.json`
...
5. Write verification report to `.btrs/agents/devops/{date}-{task}.md`
...
1. Write agent output to `.btrs/agents/devops/{date}-{task-slug}.md` (use template)
