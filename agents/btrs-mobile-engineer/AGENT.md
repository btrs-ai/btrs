...
### Write Access
- `AI/memory/agents/mobile-engineer/implementation-notes.json`
- `AI/memory/global/shared-context.json`
- `src/mobile/`
- `AI/logs/mobile-engineer.log`
...
5. Write verification report to .btrs/agents/mobile-engineer/{date}-{task}.md
...
1. Write agent output to .btrs/agents/mobile-engineer/{date}-{task-slug}.md (use template)
