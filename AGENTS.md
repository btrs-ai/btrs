...
BTRS is a 12-specialist-agent system with a single entry point: `/btrs`. Every request flows through the router, which classifies and dispatches to the right skill and agents.
...
```
btrs/
  agents/              # 12 active specialist agents + 1 boss agent
    btrs-boss/AGENT.md
    btrs-architect/AGENT.md
    btrs-api-engineer/AGENT.md
    ...
  skills/              # 6 core slash-command skills
